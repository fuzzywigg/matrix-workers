/**
 * TOKENMAXX HEAVY leftovers after #148 — spaces hierarchy soft/edge/reliability.
...
describe('spaces leftovers hierarchy empty soft reliability after #148', () => {
...
describe('spaces leftovers suggested_only soft matrix after #148', () => {
...
describe('spaces leftovers via soft flood after #148', () => {
  it('via soft-0', async () => {
    const content: Record<string, unknown> = {};
    content.via = [];
    const db = createHierarchyDb({
...
describe('spaces leftovers limit soft flood after #148', () => {
...
describe('spaces leftovers max_depth soft flood after #148', () => {
...
describe('spaces leftovers corrupt child soft flood after #148', () => {
...
describe('spaces leftovers failure edges after #148', () => {
...
describe('spaces leftovers lifecycle soft floods after #148', () => {
