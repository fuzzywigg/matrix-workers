 ...
 *
 * Hibernation sexdecenary leftovers live in call-room-hibernation.test.ts
 ...
 * and the hibernation sexdecenary describes.
 */
...
describe('race sexdecenary joinedRaw EPSILON/MAX + invited "0" after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary name null + avatar url -1/1 after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary topic 1/"" / alias -1 after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary gen FF/trailing-ws/negative parse after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary gen putThrow∥miss-refill∥hot after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary getHold∥bump∥invBatch∥batch hot after #332', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race sexdecenary getBatch putThrow∥getThrow∥hot∥inv after #332', () => {
  for (let i = 0; i < 8; i++) {
