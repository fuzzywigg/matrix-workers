/**
 * TOKENMAXX HEAVY leftovers after tip 1a3087f / post merged #402 filters quattuordecenary —
 * denary *federation* soft+concurrent-race niches unsaturated by octonary late-3pid
 * Room/No-token/Invalid/Unverifiable (#342) and nonary invite/PDU/media/auth (#364).
 * Relaunch of closed #404/#401/#386/#381/#373/#359 onto tip after #402.
 ...
 * Distinct from nonary (#364) invite/PDU/media/auth softs:
 ...
 *
 * Distinct from #332–#402 oauth/media/filters/crypto/room-cache siblings.
...
describe('soft denary federation post-verify 3pid + unsupported version after #342/#364', () => {
  for (let i = 0; i < 12; i++) {
...
describe('race denary federation post-verify 3pid + unsupported version after #342/#364', () => {
