/**
 * TOKENMAXX HEAVY tip-relaunch after #341 (main ~bed0d220) — residual
 * *turn* service concurrent-race / TOCTOU fifth-wave niches after #333
 * third-wave on tip (fourth-wave #349 open/unmerged; niches below are
 * disjoint from #349's gap table). Tip past #313/#299.
 *
 * Unsaturated by:
 ...
 *   #349 fourth-wave draft (iceServers []/null; string-urls; multi-cred
