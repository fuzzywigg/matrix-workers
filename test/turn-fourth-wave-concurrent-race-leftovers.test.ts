/**
 * TOKENMAXX HEAVY leftovers after #313 second-wave / tip past #315 —
 * residual *turn* service concurrent-race / TOCTOU fourth-wave niches
 * unsaturated by:
 ...
 *   #321 third-wave design (RATE_LIMITED∥USER_RATE_LIMITED; expiresAt<now;
 ...
 *
 * Gap table (why leftover after second/third-wave):
...
describe('race turn iceServers empty-array∥hot fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn iceServers null∥USER_RATE_LIMITED fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn string-urls flatten∥valid sibling fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn multi-credentialed pick-first∥hot fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn API 401∥USER_RATE_LIMITED fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn partial-secrets∥USER_RATE_LIMITED fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn TTL clamp 0/299/86401∥hot fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn rl requests null/string∥capped fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn putThrow(*) fail-open∥capped fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn deleteHold expired∥capped∥hot fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn fetch TypeError∥USER_RATE_LIMITED fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn 429 empty Retry-After∥USER_RATE_LIMITED fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn NaN expiresAt quirky-hit∥capped fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn remaining-ttl floor0∥cold miss fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn capped∥rl getThrow∥hot three-way fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn short-key status∥NOT_CONFIGURED∥INVALID fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn dual KEY_ID cold miss stampede fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn rl windowStart exact excluded∥capped fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn deleteThrow(*) expired∥capped fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
...
describe('race turn INVALID_RESPONSE∥capped∥stun fourth-wave after #313', () => {
  for (let i = 0; i < 8; i++) {
