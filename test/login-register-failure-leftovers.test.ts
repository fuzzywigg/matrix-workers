/**
 * TOKENMAXX HEAVY leftovers after #140 — login/register/whoami failure + reliability edges.
...
describe('login leftovers register/available failure matrix after #140', () => {
...
describe('login leftovers POST /register failure matrix after #140', () => {
...
describe('login leftovers whoami failure/reliability after #140', () => {
...
describe('login leftovers password login failure edges after #140', () => {
...
describe('login leftovers refresh failure edges after #140', () => {
...
describe('login leftovers get_token + token login failures after #140', () => {
...
describe('login leftovers lockout reliability after #140', () => {
...
describe('login leftovers guest register reliability after #140', () => {
