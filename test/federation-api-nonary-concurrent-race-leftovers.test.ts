/**
 * TOKENMAXX HEAVY leftovers after #342 — nonary *federation* soft+concurrent-race
 * niches unsaturated by octonary late-3pid exact (#342). Skip FederationCatchupWorkflow
 * and knock (own leftovers file). Lands closed septenary #335 niches that never merged.
 *
 ...
 *
 * Distinct from #332–#342 oauth/media/filters/crypto/room-cache siblings. Tests-only.
