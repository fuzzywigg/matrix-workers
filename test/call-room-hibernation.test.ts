...
/**
 * TOKENMAXX HEAVY leftovers after #353 — CallRoom hibernation *octodenary*
 * (tracks mid:null stored∥peer mute, errorCode:null falsy success∥join,
 * sessionDescription false → NO_ANSWER∥leave, tracks false INTERNAL_ERROR∥join,
 * Float64Array INVALID_MESSAGE∥join, JSON 1.5 UNKNOWN_MESSAGE∥join,
 * mute∥webSocketClose LWW, offer∥peer join). Sexdecenary stopped at mute∥leave
 * and JSON {}; septendecenary (#370 in-flight) claims mid:true / errorCode:false.
 */

describe('CallRoom hibernation octodenary sfu/error leftovers after #353', () => {
  beforeEach(() => {
    addTracksMock.mockReset();
    closeTracksMock.mockReset();
    createSessionMock.mockReset();
...
describe('CallRoom hibernation octodenary offer/json leftovers after #353', () => {
  beforeEach(() => {
    addTracksMock.mockReset();
    closeTracksMock.mockReset();
    createSessionMock.mockReset();
