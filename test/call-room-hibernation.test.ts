...
/**
 * TOKENMAXX HEAVY leftovers after #353 — CallRoom hibernation *septendecenary*
 * (tracks mid:true stored∥peer mute, errorCode:false falsy success∥join,
 * sessionDescription 0 → NO_ANSWER∥leave, tracks true INTERNAL_ERROR∥join,
 * BigUint64Array INVALID_MESSAGE∥join, JSON [] UNKNOWN_MESSAGE∥join,
 * unmute∥leave LWW, answer∥peer join). Sexdecenary stopped at mute∥leave
 * and JSON {}.
 */
