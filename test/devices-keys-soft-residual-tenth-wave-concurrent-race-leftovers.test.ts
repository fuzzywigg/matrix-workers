/**
 * TOKENMAXX HEAVY tip-relaunch at tip ~9065fa5 after #340 oauth + #342
 * admin — residual *devices + keys* soft→*concurrent-race* tenth-wave
 ...
 *
 * Gap table (why leftover after ninth-wave / tip past #342):
