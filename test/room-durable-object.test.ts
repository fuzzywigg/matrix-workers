...
/**
 * TOKENMAXX HEAVY leftovers after #353 — RoomDurableObject hibernation
 * *septendecenary* (timeout ""→0 / "-5" past / "60000" stays, Upgrade
 * "WebSocket " trailing 426∥ping, GET /receipts∥HTTP receipt, WS read∥HTTP
 * typing, webSocketError∥HTTP receipt, broadcast∥WS close, receipt thread∥HTTP
 * typing, JSON "\"x\""/1.5 silent∥HTTP). Sexdecenary stopped at JSON true/0/{}.
 */
